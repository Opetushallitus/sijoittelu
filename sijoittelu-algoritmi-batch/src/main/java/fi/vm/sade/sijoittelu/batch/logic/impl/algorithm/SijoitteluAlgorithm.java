...
public class SijoitteluAlgorithm {
    ...
    private class SijoitteleKunnesTavoiteHashTuleeVastaanTaiHeitaPoikkeus {
        ...
        public void sijoittele(HashCode tavoiteHash, Set<HakukohdeWrapper> muuttuneetHakukohteet) {
            HashCode hash = SijoitteluAlgorithm.this.sijoitteluAjo.asHash();
            ...
            do {
                ...
                hash = SijoitteluAlgorithm.this.sijoitteluAjo.asHash();
                ++i;
                if (hash.equals(tavoiteHash)) {
    ...
    private class SijoitteleKunnesValmisTaiSilmukkaHavaittu {
        ...
        public void sijoittele() {
            ...
            iteraationHakukohteet = Sets.newHashSet(SijoitteluAlgorithm.this.sijoitteluAjo.getHakukohteet());
            ...
            do {
                ...
                HashCode iteraationHash = SijoitteluAlgorithm.this.sijoitteluAjo.asHash();
                ++depth;
