...
public class PostSijoitteluProcessorPeruuntuneetHakemuksenVastaanotonMuokkausTest {
    ...
    public void testPeruuntuneenHakemuksetVastaanotonMuokkaus() {
        ...
        Assertions.assertEquals(HakemuksenTila.VARASIJALTA_HYVAKSYTTY, haeJononTilaHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067734", sijoitteluAjo).getHakemus().getTila());
        // vastaanottotieto siirtyy ylemmälle hakukohteelle
        Assertions.assertEquals(ValintatuloksenTila.VASTAANOTTANUT_SITOVASTI, haeValintatulosHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067734", sijoitteluAjo).getTila());
        // alempi hakukohde on nyt peruuntunut molemmissa sen jonoissa
        Assertions.assertEquals(HakemuksenTila.PERUUNTUNUT, haeJononTilaHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067735", sijoitteluAjo).getHakemus().getTila());
        Assertions.assertEquals(HakemuksenTila.PERUUNTUNUT, haeJononTilaHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067736", sijoitteluAjo).getHakemus().getTila());
        ...
        Assertions.assertEquals(ValintatuloksenTila.KESKEN, haeValintatulosHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067736", sijoitteluAjo).getTila());
    }
    ...
    public void testJononPeruuntuminenEiPoistaVastaanottoa() {
        ...
        Assertions.assertEquals(HakemuksenTila.HYVAKSYTTY, haeJononTilaHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067735", sijoitteluAjo).getHakemus().getTila());
        // vastaanottotieto näkyy ylemmälle
        Assertions.assertEquals(ValintatuloksenTila.VASTAANOTTANUT_SITOVASTI, haeValintatulosHakemukselle("1.2.246.562.11.00003933242", "14345398388996844110591962067735", sijoitteluAjo).getTila());
