...
public class PostSijoitteluProcessorValintaTulosServiceValinnantilojenTallennus implements PostSijoitteluProcessor {
    ...
    public void process(SijoitteluajoWrapper sijoitteluajoWrapper) {
        ...
        Stream<VastaanottoEventDto> muuttuneetValintatuloksetEventteina =
                sijoitteluajoWrapper.getMuuttuneetValintatulokset().stream().map(v -> new VastaanottoEventDto(v.getHakijaOid(), v.getHakemusOid(), v.getHakukohdeOid(), v.getHakuOid(), v.getTila(), SIJOITTELU_AS_ILMOITTAJA));
