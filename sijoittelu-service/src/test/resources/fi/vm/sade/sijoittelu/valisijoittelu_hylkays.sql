...
VALUES ('hakemus1', 'hakija1', 1, false, '83c1c848-da64-435f-be41-23a29f4d8d97', true, '{"funktioTulokset": []}', '{"syotetytArvot": []}');

INSERT INTO jarjestyskriteeritulos(arvo, nimi, prioriteetti, tila, jonosija)
SELECT 11.0, 'Testikriteeri', 0, 'HYLATTY', jonosija.id from jonosija
...
INSERT INTO jarjestyskriteeritulos(arvo, nimi, prioriteetti, tila, jonosija)
SELECT 19.0, 'Testikriteeri', 0, 'HYLATTY', jonosija.id from jonosija
