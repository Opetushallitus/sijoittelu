...
public class HakukohdeDaoImpl implements HakukohdeDao {
    ...
    public List<Hakukohde> haeHakukohteetJoihinHakemusOsallistuu(Long sijoitteluajoId, String hakemusOid) {
        ...
        String map = "function() { emit(this.oid, {className:this.className, sijoitteluajoId: this.sijoitteluajoId, oid:this.oid, tarjoajaId: this.tarjoajaId, kaikkiJonotSijoiteltu: this.kaikkiJonotSijoiteltu, valintatapajonot: this.valintatapajonot.map(function(jono) { return {tasasijasaanto: jono.tasasijasaanto, oid:jono.oid, prioriteetti: jono.prioriteetti, aloituspaikat:jono.aloituspaikat, eiVarasijatayttoa:jono.eiVarasijatayttoa, kaikkiEhdonTayttavatHyvaksytaan: jono.kaikkiEhdonTayttavatHyvaksytaan, poissaOlevaTaytto:jono.poissaOlevaTaytto, varasijat:jono.varasijat, varasijaTayttoPaivat: jono.varasijaTayttoPaivat, hakemukset:jono.hakemukset.filter(function(hakemus) { return hakemus.hakemusOid == '"+hakemusOid+"' })}})})}";
